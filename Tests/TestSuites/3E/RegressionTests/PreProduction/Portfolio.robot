...
Documentation       PreProd | Portfolio Regression
...
Test Setup          Open Browser To PREPROD Login Page
...
Check an alarm on Portfolio
    ...
    [tags]  preprod  regression  portfolio  alarms
...
Filter alarms by search item
    ...
    [tags]  preprod  regression  3585  portfolio  alarms  filter
...
Portfolio Map Data Refresh
    ...
    [tags]  preprod  regression  qackathon  portfolio  map  graphs  refresh  update

    Login Acceptance
    Page Should Be                      Page
    Element Should Be Visible           Element
    Click Element                       Open one of the sites
    Capture Page Screenshot             Base Screenshot
    Sleep                               6m
...
Tasks - scroll bar validation in the task forms
    ...
    [tags]  preprod  regression  portfolio  tasks  3995  demonstration  sprint61  VR
    ...
    Scroll All Down
    Capture Page Screenshot             ${PREPROD_VR_IMAGES_OBTAINED}/preprod_portfolio_alarms_VR_3995.png
